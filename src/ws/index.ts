...
export {WSServer,WSClient,WSServerOptions,WSClientOptions,WSSocket as WebSocket,WSServerData as WebSocketServer,WSClientData as WebSocketClient,WebSocketOptions};